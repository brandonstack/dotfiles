...
#+begin_src emacs-lisp
  ...
  (defun xing/font-size ()
   ...
   (set-face-attribute 'default nil :font "Fira Code Retina" :height (xing/font-size))

   ;; Set the fixed pitch face
   (set-face-attribute 'fixed-pitch nil :font "Fira Code Retina" :height (xing/font-size))
